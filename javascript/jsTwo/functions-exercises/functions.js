...
console.log(stringTimes("yo", 4));      //"yoyoyoyo"
...
console.log(luckySum(1, 3, 4));         //8
console.log(luckySum(13, 3, 4));        //0
console.log(luckySum(1, 13, 4));        //1
console.log(luckySum(1, 3, 13));        //4
...
console.log(caught_speeding(59, false));    //0
console.log(caught_speeding(59, true));     //0
console.log(caught_speeding(63, false));    //1
console.log(caught_speeding(63, true));     //0
...
console.log(makeBricks(2, 1, 10));      //false
console.log(makeBricks(3, 3, 10));      //true
console.log(makeBricks(1, 2, 15));      //false
console.log(makeBricks(6, 2, 15));      //true
console.log(makeBricks(6, 3, 20));      //true
console.log(makeBricks(1, 3, 20));      //false
